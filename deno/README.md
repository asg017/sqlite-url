...
[![Doc](https://doc.deno.land/badge.svg)](https://doc.deno.land/https/deno.land/x/sqlite-url@0.1.0-alpha.3/mod.ts)
...
import * as sqlite_url from "https://deno.land/x/sqlite_url@v0.1.0-alpha.3/mod.ts";
