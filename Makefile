...
bindings/sqlite-utils/sqlite_utils_sqlite_url/version.py: bindings/sqlite-utils/sqlite_utils_sqlite_url/version.py.tmpl VERSION
	VERSION=$(VERSION) envsubst < $< > $@
	echo "✅ generated $@"

sqlite-utils: $(TARGET_WHEELS) bindings/sqlite-utils/pyproject.toml bindings/sqlite-utils/sqlite_utils_sqlite_url/version.py
...
version:
	...
	make python
	make bindings/sqlite-utils/pyproject.toml bindings/sqlite-utils/sqlite_utils_sqlite_url/version.py
	make npm
	make deno
	make ruby
